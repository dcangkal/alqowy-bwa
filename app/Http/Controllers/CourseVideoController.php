...
class CourseVideoController extends Controller
{
    ...
    public function destroy(CourseVideo $courseVideo)
    {
        ...
        try{
            $courseVideo->delete();
            DB::commit();
            return redirect()->route('admin.courses.show', $courseVideo->course_id)->withSuccess('Course deleted successfully');
        }catch(\Exception $e){
            DB::rollBack();
            return redirect()->route('admin.courses.show', $courseVideo->course_id)->with('error',$e->getMessage());
        };
    }
}
